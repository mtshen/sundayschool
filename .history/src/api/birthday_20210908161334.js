...
export function addBirthdayManage(data) {
  return apiConf.axios.post(`http://${apiConf.serverIp}/addBirthdayManage`, data);
}
...
export function removeBirthdayManage(data) {
  return apiConf.axios.post(`http://${apiConf.serverIp}/removeBirthdayManage`, data);
}
export function updateBirthdayManage(data) {
  return apiConf.axios.post(`http://${apiConf.serverIp}/updateBirthdayManage`, data);
}
