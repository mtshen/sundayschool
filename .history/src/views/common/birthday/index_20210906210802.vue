  ...
  <div>
    <template>
      <el-row class="rowItem" :gutter="20">
        <el-col class="startItem" :span="8"><BirthdayCred title="本月生日" value="1" color="#cad9fd" /></el-col>
        <el-col :span="8"><BirthdayCred title="本周生日" value="1" color="#ba9dde" /></el-col>
        <el-col class="endItem" :span="8"><BirthdayCred title="本日生日" value="1" color="#eb746e" /></el-col>
      </el-row>
