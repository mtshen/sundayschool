<template>
  <el-dialog :visible="visible" width="50%" :before-close="handleClose">
    <el-form
      size="mini"
      :model="ruleForm"
      :rules="rules"
    ...
    >
      ...
      <el-form-item label="代号" prop="nickName">
        <el-input size="mini" clearable v-model="ruleForm.nickName"></el-input>
      </el-form-item>
    ...
    create() {
      this.$refs.ruleForm.validate((valid) => {
        if (valid) {
          let request;
          if (this.initVal) {
            request = updateBirthdayManage({ ...this.initVal, ...this.ruleForm });
          } else {
            request = addBirthdayManage({ ...this.ruleForm });
          }
